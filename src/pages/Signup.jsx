...
function Signup() {
  ...
  return (
    <div className="h-screen w-full flex justify-center items-center">
      <div className="w-11/12 h-auto bg-[#EFEFEF] shadow-md flex justify-center items-center flex-col  rounded-2xl py-8">
        ...
        <div className="w-11/12">
          ...
          <div className="relative w-full">
            <input
              ...
              className="border w-full h-8 rounded-md pl-3"
            />
            <button className="absolute right-2" onClick={handlePasswordVisible}>{passwordVisible ? <VisibilityIcon /> : <VisibilityOffIcon />}</button>
          </div>
        </div>
        <div className="w-11/12">
          ...
          <div className="relative w-full">
            <input
              ...
              className="border w-full h-8 rounded-md pl-3"
            />
            <button className="absolute right-2" onClick={handleConfirmPasswordVisible}>{confirmPasswordVisible? <VisibilityIcon /> : <VisibilityOffIcon />}</button>
          </div>
        </div>
